...
SELECT sorszam FROM kolcsonzes ORDER BY 1 DESC;

DELETE FROM kolcsonzes;

ALTER TABLE kolcsonzes DROP(sorszam);

ALTER TABLE kolcsonzes ADD(
sorszam NUMBER(5) GENERATED BY DEFAULT AS IDENTITY (START WITH 299));

DESC kolcsonzes

INSERT INTO kolcsonzes(sorszam,kolcsonzo,film) SELECT * FROM minta.kolcsonzes;
...
ALTER TABLE kolcsonzes ADD (datum DATE DEFAULT SYSDATE);
